...
variable1.set("Select a language")
variable2.set("Select a language")
...
if __name__ == "__main__" :
	...
	root.configure(background = '#0F2E4C')
	...
	button1 = Button(root, text = "Convert", bg = "#F47E2C", fg = "black",
								command = convert)
	
	button1.grid(row = 4, column = 1)

	button2 = Button(root, text = "Clear", bg = "#F47E2C",
